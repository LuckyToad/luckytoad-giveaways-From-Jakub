...
<div class="flex flex-col gap-2">
	<div class="flex flex-col">
		...
		<input bind:value={address} on:change={isAddressValid} type="text" class="text-white border-2 rounded-md px-2 py-1 bg-neutral-900 focus:outline-none focus:border-neutral-900 focus:ring-white w-full" />
	...
	<div class="flex justify-between text-white">
		...
		<button on:click={() => isAddressValid() && state.next()}>Continue</button>
	</div>
</div>
