...
<div class="flex flex-col items-center gap-4 font-Inter w-full">
	...
	<input bind:value={address} on:input={isAddressValid} type="text" placeholder="Ex: 0x46A7262a2198300fD8F75Fcc66040f05a034445D" class="input-field" class:input-field-valid={!error} class:input-field-invalid={error} />
	{#if error}
